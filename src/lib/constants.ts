...
export const courseCodeList = [
  'AN', 'BIO', 'BIOT', 'BITS', 'CE', 'CHE', 'CHEM', 'CS', 'ECE', 'ECON', 'EEE',
  'FIN', 'GS', 'HSS', 'INSTR', 'IS', 'MATH', 'ME', 'MF', 'MGTS', 'MSE', 'MST',
  'PHA', 'PHY'
];

export const semesterList = [
  '1 - 1', '1 - 2', 'ST 1', '2 - 1', '2 - 2', 'PS 1', '3 - 1', '3 - 2', 'ST 2',
  '4 - 1', '4 - 2', 'ST 3', '5 - 1', '5 - 2'
];

export const primaryDisciplineList = [
  'A1', 'A2', 'A3', 'A4', 'A5', 'AA', 'A7', 'A8', 'None'
];

export const gradesList = [
  'A', 'A-', 'B', 'B-', 'C', 'C-', 'D', 'E', 'NC', 'CLR', 'GD'
];
...
// Helper function to generate full course codes
export const getFullCourseCode = (courseCode: string, courseId: string) => {
